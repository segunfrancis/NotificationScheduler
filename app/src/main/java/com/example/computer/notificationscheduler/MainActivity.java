    ...
    public void scheduleJob(View view) {
        ...
        switch (selectedNetworkID) {
            case R.id.noneNetwork:
                // Job will run with or without a network connection.
                // This is the default value.
                selectedNetworkOption = JobInfo.NETWORK_TYPE_NONE;
                break;
            case R.id.anyNetwork:
                // Job will run as long as a network (cellular, Wi-Fi) is available
                selectedNetworkOption = JobInfo.NETWORK_TYPE_ANY;
                break;
            case R.id.wifiNetwork:
                // Job will run as long as the device is connected to Wi-Fi
                // that does not use a HotSpot.
